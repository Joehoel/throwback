...
export class GraphRequestError extends Schema.TaggedErrorClass<GraphRequestError>()("GraphRequestError", {
  status: Schema.Number,
  retryAfter: Schema.optionalKey(Schema.Number), // 429/Retry-After (ADR-0011)
}) {}

export class TokenUnavailable extends Schema.TaggedErrorClass<TokenUnavailable>()("TokenUnavailable", {
  userId: UserId,
}) {}

export class UnsupportedFormat extends Schema.TaggedErrorClass<UnsupportedFormat>()("UnsupportedFormat", {
  photoId: DriveItemId,
  mimeType: Schema.String, // location/orientation is JPEG only
}) {}

export class LocationVerifyTimeout extends Schema.TaggedErrorClass<LocationVerifyTimeout>()("LocationVerifyTimeout", {
