 ...
 */
function ConnectArea(): React.ReactNode {
  const { data: session, isPending } = authClient.useSession();

  if (isPending) {
    return <div className="h-11 w-44 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />;
  }
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center gap-6 p-8 text-center">
      ...
      <p className="text-lg text-neutral-600 dark:text-neutral-400">
        Koppel OneDrive om foto&apos;s na te lopen: bijschriften, typefouten en scheve scans
        verbeteren met AI.
      </p>
